export const commonStyles = {
  ...
  contentContainer: "flex flex-col lg:flex-row lg:items-stretch lg:max-h-[900px] lg:min-h-[900px]",
  textContainer: "flex items-center justify-center w-full lg:order-2 lg:w-7/12",
  textContent: "h-full px-4 pt-24 pb-16 sm:px-6 lg:px-24 2xl:px-32 lg:pt-40 lg:pb-14",
