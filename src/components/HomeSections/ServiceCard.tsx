...
export const ServiceCard = ({ service }: { service: ServiceCardProps }) => {
  ...
  return (
    ...
    >
      <motion.div
        className="relative rounded-lg overflow-hidden cursor-pointer w-80 max-w-[calc(100vw-40px)] h-60 group focus-within:ring-2 focus-within:ring-green-600" // Set a fixed height
