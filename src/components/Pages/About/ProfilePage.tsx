...
export const ProfilePage = () => {
  ...
  return (
    <div className="font-roboto text-black py-8">
      <div className="container mx-auto px-4">
        ...
        <nav className="mb-8" aria-label="Breadcrumb">
          ...
          <a className="text-black underline" href="/about/members">
            Who we are
          </a>
          <span className="mx-2 text-black-500"> &gt; </span>
        ...
        <div className="flex flex-col md:flex-row items-start">
          ...
          <div className="flex-shrink-0 mb-6 md:mb-0 md:mr-8 w-full md:w-1/3 text-center md:text-left">
            ...
            <div className="mt-4">
              ...
              <h2 className="text-xl text-black">{profile.title}</h2>
            </div>
          </div>
          ...
          <div className="w-full md:w-2/3">
            {profile.bio.map((paragraph) => {
              return (
                <p className="text-black whitespace-pre-line mb-4" key={paragraph}>
                  {paragraph}
                </p>
              );
            })}
